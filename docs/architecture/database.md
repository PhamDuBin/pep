...
| RFI | `project_attachments` | Manually attached files / 手動添付ファイル | UC06, UC07 |
| RFI | `project_plans` | Project plans generated by AI / AI生成のプロジェクト計画書 | UC06 |
| RFI | `project_plan_vendors` | Plan-Vendor delivery records / 計画書のVendor送信記録 | UC07, UC08 |
