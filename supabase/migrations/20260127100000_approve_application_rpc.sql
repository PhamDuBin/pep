...
-- 利用申請承認用RPC関数
-- Application Approval時: application/organization/profile のステータス更新と
-- applications → org_details へのデータコピーを1トランザクションで実行
-- =============================================================================
...
-- API は service_role で呼び出す想定だが、authenticated も許可
GRANT EXECUTE ON FUNCTION approve_application(UUID, UUID) TO service_role;
