  ...
  template: `
    <aside class="fixed left-0 top-[89px] bottom-0 w-[197px] bg-white flex flex-col justify-between items-start py-[15px] px-[10px] pb-[25px] z-40"
      ...
      <div class="flex flex-col items-start gap-[25px] w-[177px] h-[434px] self-stretch">
        ...
        <div>
          <button class="hover:opacity-70 transition-opacity">
            <img src="assets/icons/menu-toggle.svg" alt="Menu" width="20" height="13" />
          </button>
        </div>
        ...
        <div class="flex flex-col gap-[3px] w-full">
          <button class="flex flex-row items-center py-[3px] gap-[7px] w-full h-[26px] rounded cursor-pointer hover:bg-[#F0F0F0] active:bg-[#F0F0F0] transition-colors">
            <div class="w-5 h-5 bg-primary rounded-full flex items-center justify-center flex-shrink-0">
              <img src="assets/icons/plus.svg" alt="Plus" width="10" height="10" />
            </div>
        ...
        <div class="flex flex-col gap-[3px]">
          ...
          <div class="flex items-center gap-[7px] py-[7px] cursor-pointer hover:bg-gray-50 rounded transition-colors -mx-[10px] px-[10px]">
            <img src="assets/icons/folder.svg" alt="Archive" width="22" height="22" />
        ...
        <div class="flex flex-col gap-[5px]">
          ...
          <div class="flex flex-col gap-[5px]">
            @for (project of projects; track project.id) {
              ...
              >
                <img 
                  [src]="project.isSelected ? 'assets/icons/project-active.svg' : 'assets/icons/project.svg'" 
                  alt="Project" 
                  width="10" 
                  height="12" 
                  class="flex-shrink-0"
                ...
                @if (project.isSelected) {
                  <img src="assets/icons/more-dots.svg" alt="More" width="16" height="16" class="flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity" />
                }
              </div>
            }
          </div>
      ...
      <div class="flex flex-col justify-center items-start gap-[5px] w-[177px] h-[77px] self-stretch">
        <!-- User List -->
        <div class="flex items-center gap-[7px] py-[7px] cursor-pointer hover:bg-gray-50 rounded transition-colors -mx-[10px] px-[10px]">
          <img src="assets/icons/users.svg" alt="Users" width="29" height="16" />
