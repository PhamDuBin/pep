import { VendorContact, VendorChatMessage, VendorConversation } from '../models/carry.model';

/**
 * Current project name - matches Figma design exactly
 */
export const CURRENT_PROJECT_NAME = 'AIを利用した花屋の業務効率化';

/**
 * Mock vendor contacts matching Figma design exactly
 */
...
/**
 * Mock chat messages for vendor-1 (株式会社イチジク) matching Figma design exactly
 */
export const MOCK_CHAT_MESSAGES: VendorChatMessage[] = [
  {
    id: 'msg-1',
...
/**
 * Mock conversation data for vendor-1 matching Figma design
 */
