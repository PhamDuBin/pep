...
export const PROJECT_PLAN_CONTENT_MOCK: ProjectPlanContent = {
...
顧客対応や在庫管理の自動化により、業務負荷を30%削減する`,
  ...
  schedule: [
    ...
    },
    {
      ...
      name: "設計・開発",
      period: "2026年5-8月",
      description: "システム設計と開発",
    },
    {
      phase: 3,
      name: "テスト・導入",
      period: "2026年9-10月",
      description: "テストと本番導入",
    },
    {
      phase: 4,
      name: "運用・改善",
...
export const PDF_PAGES_MOCK: PdfPage[] = [
...
export const PROJECT_PLAN_MOCK: ProjectPlan = {
  id: "plan-001",
  title: "AIを利用したお花屋さん・2026年3月開始・花屋・1年間",
  content: PROJECT_PLAN_CONTENT_MOCK,
  pdfPages: PDF_PAGES_MOCK,
  status: "preview",
...
export const VENDORS_MOCK: Vendor[] = [
  { id: "v1", name: "株式会社イチジク", isSelected: false },
  { id: "v2", name: "株式会社ブルーベリー", isSelected: false },
  { id: "v3", name: "株式会社チェリー", isSelected: false },
  { id: "v4", name: "株式会社ピーチ", isSelected: false },
  { id: "v5", name: "株式会社ペアー", isSelected: false },
  { id: "v6", name: "株式会社ライチ", isSelected: false },
  { id: "v7", name: "株式会社バナナ", isSelected: false },
  { id: "v8", name: "株式会社マンゴー", isSelected: false },
  { id: "v9", name: "株式会社パパイヤ", isSelected: false },
  { id: "v10", name: "株式会社オレンジ", isSelected: false },
  { id: "v11", name: "株式会社キウイ", isSelected: false },
  { id: "v12", name: "株式会社メロン", isSelected: false },
  { id: "v13", name: "株式会社グレープ", isSelected: false },
  { id: "v14", name: "株式会社アボカド", isSelected: false },
  { id: "v15", name: "株式会社スイカ", isSelected: false },
...
export const PROJECT_PLAN_AI_RESPONSE_MOCK = `プロジェクト実行計画書
1. 背景・目的・ゴール
背景・経緯:
...
export const PROJECT_PLAN_COST_RESPONSE_MOCK = `5. 要員・コスト計画
部署 人数 期間 単価 合計
...
export const MODE_DESCRIPTION_MOCK =
  "プロジェクト概要から5項目(目的・ゴール/スコープ/日程計画/品質基準/体制・役割)に構造化されたPDF計画書を自動生成します";

export const CHAT_INPUT_PLACEHOLDER_MOCK =
