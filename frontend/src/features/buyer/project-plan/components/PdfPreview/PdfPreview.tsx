  ...
  return (
    <div className="block w-full max-w-[500px] p-[16px] bg-white border border-[#b9b9b9] rounded-[8px] animate-fade-in-up">
      ...
      <div className="flex justify-between items-center mb-[16px]">
        <h3 className="text-[14px] font-normal text-[#333] m-0">
          PDFページプレビュー
        </h3>
        <span className="text-[14px] text-[#066a9e]">
      ...
      <div className="flex gap-[12px] mb-[16px] overflow-x-auto pb-[8px] [&::-webkit-scrollbar]:h-[4px] [&::-webkit-scrollbar-track]:bg-[#f1f1f1] [&::-webkit-scrollbar-track]:rounded-[2px] [&::-webkit-scrollbar-thumb]:bg-[#c1c1c1] [&::-webkit-scrollbar-thumb]:rounded-[2px]">
        {pages.map((page) => (
          ...
          >
            ...
            {/* Page Title */}
            <span className="text-[12px] text-[#333] text-center whitespace-nowrap">
              {page.title}
            </span>
      ...
      <div className="flex gap-[12px]">
        ...
        <button
          type="button"
          className="py-[8px] px-[24px] bg-[#808080] border-none rounded-[8px] text-[14px] text-white cursor-pointer transition-opacity duration-200 hover:opacity-90"
          onClick={onConfirm}
        >
          確認
        </button>
