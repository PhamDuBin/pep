          ...
          <div className="flex flex-col gap-[5px] items-start justify-center w-full">
            ...
            <div className="flex font-noto-jp font-semibold items-end">
              <p className="text-[#333] leading-normal">
                <span className="text-[24px]">月額</span>
                <span className="text-[26px]">￥980</span>
              </p>
              <p className="text-[#333] text-[16px] leading-normal">（税別）</p>
              <p className="text-[#808080] text-[16px] leading-normal">
                /人（4人目以降¥500）
              </p>
            </div>
          </div>
