...
import { TabNavigation, Modal, PageTransition } from "@/shared/components";
                        ...
                        <div className="relative">
                          <button
                            ...
                            className={`flex items-center justify-center w-[20px] h-[20px] bg-transparent border-none cursor-pointer p-0 rounded-[4px] transition-colors duration-150 hover:bg-[rgba(0,0,0,0.05)] ${
                              showVendorMenu === vendor.id ? "bg-[rgba(0,0,0,0.05)]" : ""
                            }`}
                  ...
                  <div className="flex flex-col gap-[10px] w-full">
                    {messages.map((msg) => (
                      ...
                      >
                        ...
                        <div className={`flex flex-col gap-[2px] max-w-[60%] min-w-[200px] ${
