...
export default function CarryPage() {
  ...
  const [messages, setMessages] = useState<VendorChatMessage[]>(MOCK_VENDOR_CHAT_MESSAGES);
              ...
              <div className={styles.chatHeader}>
                ...
                <div className={styles.headerRight}>
                  ...
                  <div className={styles.memberBadge}>
                    <span className={styles.memberCount}>{MOCK_MEMBERS.length}</span>
                  </div>
                    ...
                    {showMemberDropdown && (
                      <div className={styles.memberDropdown}>
                        ...
                        <div className={styles.membersSection}>
                          <p className={styles.membersLabel}>メンバー({MOCK_MEMBERS.length})</p>
